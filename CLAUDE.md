# INT_DESIGN_test — 我的班級工具總專案

## 對話開始時請先讀
進度與最近更動都在 Obsidian：`OBSIDIAN/INT_DESIGN_test/工作筆記.md`
...
## 工作桌 + 三個家
- 📋 GDrive 工作桌：`G:\我的雲端硬碟\INT_DESIGN_test\`（自動跨電腦同步）
- 🐙 GitHub repo：`linliter-K/INT_DESIGN_test`（公開，網頁的家）
- 📘 Obsidian 駕駛艙：`OBSIDIAN/INT_DESIGN_test/工作筆記.md`（想法的家）
